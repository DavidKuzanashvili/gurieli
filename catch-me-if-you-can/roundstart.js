function RoundStart() {
  ...
  function roundStartInit() {
    ...
    title = new Title(width / 2, height / 2 - 150, 'Round: ' + (CURRENT_LEVEL + 1), LEVEL[CURRENT_LEVEL].color, 60);
    ...
    subTitle = new Title(width / 2, height - 70, 'Collect ' + LEVEL[CURRENT_LEVEL].fruitName, LEVEL[CURRENT_LEVEL].color, 40);
